...
#include <cmath>
#include <iomanip>
#include <[insert path here]/lib/boost_1_75_0/boost/math/distributions/empirical_cumulative_distribution_function.hpp>
                       ...
                       size_t n_bins)
{
    ...
    double cv_005 = 1.358 * std::sqrt(2*nm/(double)(nm*nm));
